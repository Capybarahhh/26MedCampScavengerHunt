...
export {
  ...
  PIECE_D, PIECE_SW, PIECE_PW, PIECE_PH,
  buildPiecePath, pieceLeftTear, pieceRightTear, makePieceNode,
  ASSEMBLY_SCALE, ASSEMBLY_SLOT_STEP, ASSEMBLY_PIECE_W, ASSEMBLY_WIDTH,
  ASSEMBLY_PIECE_H, ASSEMBLY_TABLE_H, ASSEMBLY_GAP, ASSEMBLY_SLOT_TOP, ASSEMBLY_AREA_H,
};
